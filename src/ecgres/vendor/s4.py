...
# Vendored from HazyResearch/state-spaces, commit 137e49d,
# src/models/sequence/ss/standalone/s4.py - Apache License 2.0.
# Modified: removed the pytorch_lightning dependency (rank_zero_only -> no-op).
# No other changes.
...
rank_zero_only = lambda fn: fn  # MODIFIED: was a pytorch_lightning import
